...
~> **Deprecated** Use [`opnsense_kea_dhcpv4_subnet`](../data-sources/kea_dhcpv4_subnet) instead. This data source will be removed in a future release.
...
```terraform
data "opnsense_kea_subnet" "example" {
  id = "<uuid>"
}
```
