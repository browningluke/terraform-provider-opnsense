		...
		Steps: []resource.TestStep{
			// Create and Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("opnsense_ipsec_child.test", "connection", "connection-uuid-123"),
...
`, enabled, connection, strings.Join(proposals, `", "`), sha256_96, startAction, closeAction,
...
resource "opnsense_ipsec_child" "test" {
  enabled         = "1"
  connection      = "connection-uuid-multiple"
